...
<div class="dark:bg-ctp-crust
grow flex flex-col
relative overflow-hidden">
    <header class="p-3 flex gap-3 bg-ctp-mantle border-ctp-surface0 border-b border-px">
        <button class="hover:bg-ctp-surface1 rounded-md" style="width: 2em; height: 2em;" on:click={() => menu_open = !menu_open}>
            <span class="
                text-2xl
        ...
        <button class="hover:bg-ctp-surface1 rounded-md" style="width: 2em; height: 2em;" on:click={() => sidebar_open = !sidebar_open}>
            <span class="
                text-2xl
                material-symbols-outlined">
                code
    ...
    <div class="flex grow overflow-scroll">
        {#if menu_open}
            ...
            <ol class="list-decimal grow pl-5 text-pretty break-words flex flex-col">
                <a href="./test">
                    <li class="hover:bg-ctp-surface0 p-1">
                        Introduction
                    </li>
                </a>
                <a href="./test">
                    <li class="hover:bg-ctp-surface0 p-1">
                        Analysisssssssssssssssssssssssssssssssssssss
                    </li>
                </a>
                <a href="./test">
                    <li class="hover:bg-ctp-surface0 p-1">
                        Items and testing; comparative analytics
                    </li>
                </a>
            </ol>
            </div>
        ...
        <div class="flex flex-col grow items-center overflow-scroll gap-6 z-0">
            <div class="flex flex-col grow pt-6" style="width: 37rem; max-width: 37rem;">
                <slot />
            </div>
        </div>
        <!-- <div class="grow"></div> -->
